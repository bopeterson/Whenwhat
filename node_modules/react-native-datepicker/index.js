...
class DatePicker extends Component {
  ...
  render() {
    ...
    if (this.props.width.a==0) {
      ...
      widthstyle={width:this.props.width.a*Math.floor(this.props.minDim/this.props.width.b+0.5)};
    }
    
    
    return (
      <TouchableComponent
        style={[widthstyle,style,{borderTopWidth:borderTopWidth,borderLeftWidth:borderLeftWidth,borderRightWidth:borderRightWidth,borderBottomWidth:borderBottomWidth}]}
